...
public partial class NorthwindOriginalContext : DbContext
{
    ...
    {
        //optionsBuilder.UseSqlServer("Data Source=DESKTOP-CP53DG4\\SQLEXPRESS; Database=NorthwindOriginal;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
        return;
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.DocumentationId).HasName("PK__Document__6A001A8D994059B1");
